                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        ...
                        <div class="collapse in" id="formsExamples">
                            <ul class="nav">
                                <li class="active">
                                    <a href="regular.html">Regular Forms</a>
                                </li>
                                <li>
                                    <a href="extended.html">Extended Forms</a>
                                </li>
                                <li>
                                    <a href="validation.html">Validation Forms</a>
                                </li>
                                <li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="#" action="#">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Denemurator</label>
                                            <input type="text" class="form-control">
                                        </div>
                                        <button type="submit" class="btn btn-fill btn-rose">Tambahkan</button>
                                    </form>
                        ...
                        <!-- <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Tambah Data Jumlah</h4>
                                    <form method="POST" class="data">
                                       <div class="form-group">
                                            <select class="selectpicker" data-style="select-with-transition" single
                                                title="Pilih Unit" data-size="7">
                                                <option disabled> Pilih Unit</option>
                                                <option value="2">Unit 1 </option>
                                                <option value="3">Unit 2 </option>
                                            </select>
                                        </div>
                        <div class="form-group">
                            <select class="selectpicker" data-style="select-with-transition" single
                                title="Pilih Indikator" data-size="7" name="indikatorchild" id="indikatorchild">
                                <option value="" selected> Pilih Numerator</option>
                                <?php foreach($indikator as $num) : ?>
                                <option value="<?= $num->id ?>"><?= $num->numerator ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="selectpicker" data-style="select-with-transition" single
                                title="Pilih Indikator" data-size="7" name="indikatorchild" id="indikatorchild">
                                <option value="" selected> Pilih Denemurator</option>
                                <?php foreach($indikator as $den) : ?>
                                <option value="<?= $den->id ?>"><?= $den->denumerator ?></option>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Indikator Unit</h4>
                        <div class="toolbar">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="penilaian" method="POST">
                                            <div class=" row">
                                                <div class="col-md-10">
                                                    <div class="form-group label-floating">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group label-floating">
                                                        <select class="selectpicker" data-style="select-with-transition"
                                                            ...
                                                            <?php foreach($data as $d) : ?>
                                                            <option value="<?= $d->id?>"><?= $d->numerator ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group label-floating">
                                                        <select class="selectpicker" data-style="select-with-transition"
                                                            ...
                                                            <?php foreach($data as $d) : ?>
                                                            <option value="<?= $d->id?>"><?= $d->denumerator ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal fade" id="addIndikatorModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="addIndikator" method="POST">
                                            <div>
                                                <div class="form-group label-floating">
                                                    <option value=""></option>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-dismiss="modal">Tutup</button>
                                        <button type="button" class="btn btn-primary">Tambah Indikator</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>2011/04/25</td> -->
                                        <td class="text-right">
                                            <a data-toggle="modal" data-target="#addNilaiModal"
